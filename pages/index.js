...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.h1}>ALI Chain Community </h1>
      <br     />
      <h2>If you are among our community you will be Rewarded</h2>
      ...
      You will be Rewarded if you are a Member   {" "}
        ...
        >
           ...
           that you will be able to Mint your discord photo to your own NFT or any NFT you have in discord for free.
      </p>
      {/* <p className={styles.explain}>
